...
class Hand(object):
    ...
    def update(self, word):
        ...
        # create a dictionary of the word
        wordDict = {}
        for char in word:
            wordDict[char] = wordDict.get(char, 0) + 1
        # for each letter in the word dictionary, are the number of instances 
        # less than or equal to the number of instances in the hand
